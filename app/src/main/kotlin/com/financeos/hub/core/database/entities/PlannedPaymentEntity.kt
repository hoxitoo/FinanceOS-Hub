...
data class PlannedPaymentEntity(
     ...
     *
     * Граница известна: если под обязательство подходят ДВЕ неразличимые операции, отвергнув
     * вторую, человек снова освобождает первую. Список отвергнутых закрыл бы это, но потребовал бы
     * разбора строки или отдельной таблицы — цена выше вреда, потому что две операции, одинаковые
     * по сумме, дате, счёту и направлению, одинаково правдоподобны как закрывающие.
     */
